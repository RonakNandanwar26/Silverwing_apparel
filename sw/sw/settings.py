...
SECRET_KEY = 'django-insecure-3wzaz+f#kazbvo6wg+-%j4iyf#%^=%*lohs!#*hftk+y5jg!et'
...
if DEBUG:
    MEDIA_URL = '/media/'
    STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "sw", "static", "static-only")
    MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "sw", "static", "media")
    STATICFILES_DIRS = (os.path.join(os.path.dirname(BASE_DIR), "sw", "static", "static"),)
...
ACCOUNT_LOGOUT_REDIRECT_URL = '/hello/home/'
